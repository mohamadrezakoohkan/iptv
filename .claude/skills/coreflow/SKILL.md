...
(`.claude/agents/*.md`), skills (`.claude/skills/**`), saved workflows
(`.claude/workflows/**`), templates (`docs/adrs/`, `tasks/`,
`failures/TEMPLATE.md`), `.claude/settings.json`, hooks (`.claude/hooks/**`), or
