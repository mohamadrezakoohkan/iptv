...
(`docs/specs/iptv-player.md` §2) so it recolours automatically under either theme.
...
The channel grid (`docs/specs/iptv-player.md` §5c) currently renders
...
The player card (`docs/specs/iptv-player.md` §5b) has two no-output states; both are
...
- The error placeholder still surfaces error text as visible text, never
  console-only (`docs/specs/iptv-player.md` §12).
...
- Every action button is keyboard-focusable and has a discernible accessible
  name, consistent with `docs/specs/iptv-player.md` §12.

---

## 5. Out of scope

- No new state-machine phases (`docs/specs/iptv-player.md` §11 is unchanged); these
