...
governs:
  ...
  - src/tests/unit/foot.test.js
  - src/tests/unit/m3u-ui.test.js
  - src/tests/unit/persist.test.js
  - src/tests/ui/m3u-ui.test.js
  - src/tests/ui/m3u.test.js
  - src/tests/ui/foot.test.js
  - src/tests/ui/persist.test.js
  - src/tests/int/m3u.test.js
  - src/tests/int/strm.test.js
---
